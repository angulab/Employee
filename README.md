...
[![Build Status](https://travis-ci.org/iatec-docs/EmployeeApi.svg?branch=master)](https://travis-ci.org/iatec-docs/EmployeeApi)
...
6. If you did everything correct, https://iatec-docs.github.io/EmployeeApi/ will lead to your new docs
...
- Documentation(ReDoc): https://iatec-docs.github.io/EmployeeApi/
- SwaggerUI: https://iatec-docs.github.io/EmployeeApi/swagger-ui/
- Look full spec:
    + JSON https://iatec-docs.github.io/EmployeeApi/swagger.json
    + YAML https://iatec-docs.github.io/EmployeeApi/swagger.yaml
- Preview spec version for branch `[branch]`: https://iatec-docs.github.io/EmployeeApi/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://iatec-docs.github.io/EmployeeApi/ with url from the message: `Server started <url>`
